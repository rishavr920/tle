...
void solve() {
    ...
    //find consecutive dot if i able to find consecutive dot of 3 ya 3 se jada till last of row to final ans is 2,
    //nai to kch ni har dot ka sum rkho return kr dena.
